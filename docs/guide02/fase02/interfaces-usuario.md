...
![Formulario de inicio de sesión FisiConnect](mockups/login.png)
*Interfaz de autenticación con validación de correo UNMSM*

### **Mockup 02: Página de Inicio**
![Dashboard principal de FisiConnect](mockups/inicio.png)
...
![Interfaz de búsqueda avanzada](mockups/busqueda.png)
*Sistema de búsqueda con filtros múltiples y resultados*

### **Mockup 05: Detalle de Material**
![Vista detallada de material académico](mockups/detalle-material.png)
*Página de material específico con comentarios y calificaciones*

### **Mockup 06: Subir Materiales**
![Formulario para subir nuevos materiales](mockups/subir-material.png)
